...
function inviteLink(req, token) { return `${baseUrl(req)}/e/${token}`; }
...
app.listen(PORT, () => {
  console.log(`MAYSAN appraisal server listening on http://localhost:${PORT}`);
  console.log(`Admin PIN: ${ADMIN_PIN === '056023' ? '056023 (default — change APPRAISAL_ADMIN_PIN in production)' : 'set via env'}`);
});
