    ...
    content.innerHTML = h('اعتماد البيانات') + steps(4) +
      `<div class="grid g-2">
        <div class="panel"><div class="panel-head"><h3>فترة التقرير</h3></div><div class="panel-body">
          ${p.confident ? `<div class="data-note" style="border-color:rgba(22,163,74,.3);background:rgba(22,163,74,.06);color:var(--green-700)">✓ تم تحديد الفترة من اسم الملف: <b>${fmt.esc(p.label)}</b></div>` : `<div class="data-note">⚠️ تعذّر تحديد الفترة من اسم الملف بدقة. تم استخدام تاريخ الرفع — يمكنك تعديلها.</div>`}
          <div class="form-grid">
